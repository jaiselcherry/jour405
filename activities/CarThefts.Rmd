...
#I would say the data is left-skewed, because more of the data falls to the left of the mode than to the right. More data appears to fall within the standard deviations of the mean than does not. More data falls one standard deviation above the mean than one standard deviation below the mean.
